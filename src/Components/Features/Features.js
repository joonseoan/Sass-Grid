        ...
        <div className="features">
            <div className="feature">
                <svg className="feature__icon">
                    <use href="img/sprite.svg#icon-global" />
                </svg>
                <h4 className="head-4 head-4--dark">World's best luxury homes</h4>
            ...
            <div className="feature">
                <svg className="feature__icon">
                    <use href="img/sprite.svg#icon-trophy" />
                </svg>
                <h4 className="head-4 head-4--dark">Only the best properties</h4>
                <p className="feature__text">
            ...
            <div className="feature">
                ...
                <h4 className="head-4 head-4--dark">All homes in top locations</h4>
                <p className="feature__text">
            ...
            <div className="feature">
                ...
                <h4 className="head-4 head-4--dark">New home in one week</h4>
                <p className="feature__text">
            ...
            <div className="feature">
                <svg className="feature__icon">
                    <use href="img/sprite.svg#icon-presentation" />
                </svg>
                <h4 className="head-4 head-4--dark">Top 1% realtors</h4>
                <p className="feature__text">
            ...
            <div className="feature">
                <svg className="feature__icon">
                    <use href="img/sprite.svg#icon-lock" />
                </svg>
                <h4 className="head-4 head-4--dark">Secure payments on Nexter</h4>
                <p className="feature__text">
